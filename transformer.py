...
class CFTransformerEncoder(Module):
    ...
    def __init__(self, hidden_channels=256, edge_channels=64, key_channels=128,
                 num_heads=4, num_interactions=6, k=32, cutoff=10.0):
        super().__init__()
        ...
        # self.atom_emb = Linear(atom_feature_dim, hidden_channels)
